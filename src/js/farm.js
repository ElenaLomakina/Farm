        ...
        this.resources.forEach(function (resource) {
            ...
            if (resourceHarvest) {
                if (existPosition) {
                    ...
                    dom.blockContent(positionQuantity, "<span>Quantity: </span>" + existPosition.quantity);
                }
                else {
                    self.addToStorage(new products.StoragePosition(resource.product, resourceHarvest));
                }
            }
        })
    };
